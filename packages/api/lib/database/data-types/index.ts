...
import type { FieldDefinition, Operator } from './../types'
...
export function getDataTypeOperators<T extends DataTypes>(type: T): Operator[] {
  return getDataTypeDefinition(type).operators ?? getDataTypeGroupDefinition(type).operators ?? Object.keys(OPERATORS) as Operator[]
}

export type DataTypeGroupDefinitions = Record<string, DataTypeGroupProps>

export type DataTypeGroupProps = {
