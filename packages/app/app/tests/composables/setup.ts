...
const shared = vi.hoisted(() => ({
  ...
  toastSuccess: vi.fn(),
  toastAlert: vi.fn(),
  relation: { table: 'hubify_collections' as TableNames, foreignKey: 'collection_id' },
  getRelation: vi.fn()
}))
...
beforeEach(() => {
  ...
  shared.relation = { table: 'hubify_collections' as TableNames, foreignKey: 'collection_id' }
...
export function setRelationResult(relation: { table: TableNames, foreignKey: string }) {
